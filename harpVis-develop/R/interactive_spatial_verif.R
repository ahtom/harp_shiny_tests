#' @rdname interactive_spatial_verif
#' @inheritParams dashboard_spatial_verifUI
#' @export

interactive_spatial_verifUI <- function(id) {
...
#' @export
interactive_spatial_verif <- function(
  ...
  output$plot <- shiny::renderPlot({
    ...
    if (score_options()$line_cols == "mname") {
      ...
      score_plot <- harpVis::plot_spatial_verif(
        verif_data(),
        !!plot_score,
